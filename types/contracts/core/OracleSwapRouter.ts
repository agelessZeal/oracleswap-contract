...
export interface OracleSwapRouterInterface extends utils.Interface {
  functions: {
...
export interface OracleSwapRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OracleSwapRouterInterface;
