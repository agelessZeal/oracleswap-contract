...
export interface OracleSwapFactoryInterface extends utils.Interface {
  functions: {
...
export interface OracleSwapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OracleSwapFactoryInterface;
