...
export interface IOracleSwapFactoryInterface extends utils.Interface {
  functions: {
...
export interface IOracleSwapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOracleSwapFactoryInterface;
