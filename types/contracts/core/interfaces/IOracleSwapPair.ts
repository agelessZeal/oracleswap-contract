...
export interface IOracleSwapPairInterface extends utils.Interface {
  functions: {
...
export interface IOracleSwapPair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOracleSwapPairInterface;
