...
export interface IOracleSwapRouterInterface extends utils.Interface {
  functions: {
...
export interface IOracleSwapRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOracleSwapRouterInterface;
